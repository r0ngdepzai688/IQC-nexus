    ...
    switch (status) {
      ...
      case "Ready":
        return (
          <Badge
            variant="default"
            className="bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500/20 gap-1 border-none"
          >
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-muted/50 hover:bg-muted/50">
            ...
            <TableHead>Pre-PVR Target</TableHead>
              ...
              >
                ...
                <TableCell>
                  <div className="flex gap-2">
                    <span title="LPR Qty" className="text-sm">
                      {record.qtyLpr}
                    </span>
