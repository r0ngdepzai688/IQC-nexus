# IQC Nexus Client Agent — Security Architecture (Phase 3A.5)
...
4. **Local Work Directory Security**: `NascaWorkDirectoryManager` uses opaque folder names (`work_<correlationId>`), atomic file staging, hash verification, root boundary containment, and quarantines suspicious or corrupt directories.
